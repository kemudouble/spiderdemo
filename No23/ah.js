...
const JSEncrypt = require("C:\\Users\\chujiaxiang\\Desktop\\ccc\\spiderDemo\\No23\\haha.js")
function cumpt(page) {
var c = page, a = "fsymmetry_challenge",
o = Date.now()
...
// console.log(`XAuthKey: ${XAuthKey}`, `XSignature: ${XSignature}`, `verify: ${i}`, `data: ${l}`)